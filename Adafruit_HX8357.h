...
#define STMH743ZI_SPI_PORT hspi1
typedef struct SPI_HandleTypeDef SPI_HandleTypeDef;
extern SPI_HandleTypeDef STMH743ZI_SPI_PORT;

#define STMH743ZI_RES_Pin       GPIO_PIN_7
#define STMH743ZI_RES_GPIO_Port GPIOC
#define STMH743ZI_CS_Pin        GPIO_PIN_4
#define STMH743ZI_CS_GPIO_Port  GPIOA
#define STMH743ZI_DC_Pin        GPIO_PIN_4
#define STMH743ZI_DC_GPIO_Port  GPIOB